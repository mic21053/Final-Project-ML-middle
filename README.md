...
Надо сказать, что библиотека для захвата видео OpenCV плохо "дружит" с Ubuntu. А точнее с командой cv2.waitKey(). Прилось найти решение, не убивающее ядро при использовании этой клавиши. Поэтому для выхода из показа используется нажатие любой клавиши на клавиатуре.  
